...
def hilfe():
    ...
    table.add_row('felder', 'TEXT')
    table.add_row('lockern feldId', 'TEXT')
    table.add_row('pflanzen feldId', 'TEXT')
    table.add_row('gießen feldId', 'TEXT')
    table.add_row('ernten feldId', 'TEXT')
